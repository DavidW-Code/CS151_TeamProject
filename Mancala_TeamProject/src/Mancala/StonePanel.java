...
ArrayList<JLabel> stoneLabelB;
	...
	public void stateChanged(ChangeEvent e) {
		...
		for (int i = 0; i < PlayerA.size(); i++) {
			System.out.print(" A " + PlayerA.get(i));
		}
		System.out.println("");
		for (int i = 0; i < PlayerA.size(); i++) {
			System.out.print(" A " + stoneLabelA.get(i).getComponentCount());
		}
		System.out.println("");
		for (int i = 0; i < PlayerB.size(); i++) {
			System.out.print(" B " + PlayerB.get(i));
		}
		System.out.println("");
		for (int i = 0; i < PlayerB.size(); i++) {
			System.out.print(" B " + stoneLabelB.get(i).getComponentCount());
		}
		System.out.println("");
		*/
		revalidate();
